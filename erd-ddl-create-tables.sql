CREATE TABLE staff (id number(10) GENERATED BY DEFAULT AS IDENTITY, first_name varchar2(128) NOT NULL, last_name varchar2(128) NOT NULL, start_date date NOT NULL, sales_outlet_id number(10), position_id number(10) NOT NULL, PRIMARY KEY (id));
