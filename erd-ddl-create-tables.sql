...
CREATE TABLE staff (id number(10) GENERATED BY DEFAULT AS IDENTITY, firstName varchar2(128) NOT NULL, lastName varchar2(128) NOT NULL, startDate date NOT NULL, location number(10) NOT NULL, position number(10) NOT NULL, PRIMARY KEY (id));
