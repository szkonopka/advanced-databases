...
execute_sql ./2.2/2.3.sql > ./results/2.3.sql
echo "2.3 - finished"

echo "2.4 - performing tests"
execute_sql ./2.2/2.4.sql > ./results/2.4.sql
echo "2.4 - finished"

echo "2.5 - performing tests"
execute_sql ./2.2/2.5.sql > ./results/2.5.sql
echo "2.5 - finished"

echo "2.6 - performing tests"
execute_sql ./2.2/2.6.sql > ./results/2.6.sql
echo "2.6 - finished"

echo "2.7 - performing tests"
execute_sql ./2.2/2.7.sql > ./results/2.7.sql
echo "2.7 - finished"
